            ...
            <LinearGradient colors={["#667eea", "#764ba2"]} style={styles.gradient}>
                ...
                >
                    ...
                    >
                        ...
                        <SyncLoadingOverlay isVisible={isSyncing} message={syncMessage} progress={syncProgress} />
                            ...
                            <View style={styles.form}>
                                ...
                                >
                                    <Text style={styles.loginButtonText}>
                                        {loading ? "Signing In..." : (isSyncing ? "Syncing Data..." : "Sign In")}
                                    </Text>
                                </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    footerText: { color: 'rgba(255, 255, 255, 0.7)', fontSize: 14, marginBottom: 4, },
});
