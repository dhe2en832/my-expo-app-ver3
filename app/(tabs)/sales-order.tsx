...
//       Alert.alert(
//         "Tidak Bisa Kirim",
//         "Hanya pesanan draf yang bisa dikirim untuk persetujuan"
//       );
//       return;
//     }
...
//               const mockIndex = mockSalesOrders.findIndex(
//                 (o) => o.id === order.id
//               );
//               if (mockIndex !== -1) {
...
//               Alert.alert(
//                 "Sukses",
//                 "Pesanan berhasil dikirim untuk persetujuan"
//               );
//             } catch (error) {
...
//                         ...prev,
//                         customerId:
//                           prev.customerId === customer.id ? "" : customer.id,
//                       }))
//                     }
//                   >
//                     <Text
